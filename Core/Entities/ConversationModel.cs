...
namespace TLGames.Core.Entities
{
    public class ConversationModel
    {
        ...
        public EConversationStatus Status { get; private set; }

        public ConversationModel() { }

        public ConversationModel(int conversationId, int firstUserId, int secondUserId, DateTime startTime, DateTime lastMessageTime, EConversationStatus status)
        {
        ...
        public void SetStatus(EConversationStatus status) { Status = status; }
    }
}
