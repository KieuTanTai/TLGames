...
namespace TLGames.Core.Entities
{
    public class TransactionModel
    {
        ...
        public TransactionModel(int transactionId, int walletId, int invoiceId, int platformRuleId,
                                DateTime transactionDate, ETransactionType transactionType, decimal currentBalance, ETransactionStatus status)
        {
        ...
        public void SetTransactionType(ETransactionType type) { TransactionType = type; }
        public void SetCurrentBalance(decimal balance) { CurrentBalance = balance; }
        public void SetStatus(ETransactionStatus status) { Status = status; }
    }
}
