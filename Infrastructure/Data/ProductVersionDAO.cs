...
{
    internal class ProductVersionDAO(IDbConnectionFactory connectionFactory) : BaseDAO<ProductVersionModel>(connectionFactory), ISoftDeleteAsync<ProductVersionModel>,
                                        IGetAllByIdAsync<ProductVersionModel>, IGetRelativeAsync<ProductVersionModel>, IGetDataByDateTime<ProductVersionModel>
    {
