...
namespace TLGames.Infrastructure.Data
{
    public class ProductDescriptionDAO(IDbConnectionFactory connectionFactory, IColumnService colService, IStringConverter converter, IStringChecker checker)
        ...
        IGetRelativeAsync<ProductDescriptionModel>, IGetDataByDateTimeAsync<ProductDescriptionModel>
    {
        ...
        public async Task<List<ProductDescriptionModel>> GetAllByTimeRangeAsync<TEnum>(string firstInputTime, string secondInputTime, string colName, TEnum timeType) where TEnum : Enum
        {
        ...
        public async Task<List<ProductDescriptionModel>> GetAllByTimeAsync<TEnum>(string time, string colName, TEnum timeType) where TEnum : Enum
        {
            if (timeType is EDataTimeType)
            {
                string query = string.Empty;
