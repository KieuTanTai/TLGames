...
namespace TLGames.Infrastructure.Data
{
    ...
    internal class FollowerOfPublisherDAO(IDbConnectionFactory connectionFactory,
                                        string tableName,
                                        string columnIdName,
                                        string secondColumnIdName) : BaseDAO<FollowerOfPublisherModel>(connectionFactory, tableName, columnIdName, secondColumnIdName), IGetAllByIdAsync<FollowerOfPublisherModel>,
