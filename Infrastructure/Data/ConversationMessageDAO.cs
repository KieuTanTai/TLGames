...
{
    internal class ConversationMessageDAO(IDbConnectionFactory connectionFactory,
                                        string tableName,
                                        string columnIdName) : BaseDAO<ConversationMessageModel>(connectionFactory, tableName, columnIdName),
