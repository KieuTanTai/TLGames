...
namespace TLGames.Infrastructure.Data
{
    ...
    public class UserRelationshipDAO(IDbConnectionFactory connectionFactory, IColumnService colService, IStringConverter converter, IStringChecker checker)
        : BaseDAO<UserRelationshipModel>(connectionFactory, colService, converter, checker, "user_relationships", "requester_id", "receiver_id"),
        IGetAllByIdAsync<UserRelationshipModel>, IGetSingleByIdsAsync<UserRelationshipModel>, IGetDataByDateTimeAsync<UserRelationshipModel>, IGetDataByEnumAsync<UserRelationshipModel>, IDeleteByIdsAsync
    {
        ...
        // search by enum
        public async Task<List<UserRelationshipModel>> IGetAllByEnumAsync<TEnum>(TEnum value, string colName) where TEnum : Enum
        {
        ...
        public async Task<List<UserRelationshipModel>> GetAllByTimeRangeAsync<TEnum>(string firstInputTime, string secondInputTime, string colName, TEnum timeType) where TEnum : Enum
        {
        ...
        public async Task<List<UserRelationshipModel>> GetAllByTimeAsync<TEnum>(string time, string colName, TEnum timeType) where TEnum : Enum
        {
            if (timeType is EDataTimeType)
            {
                string query = string.Empty;
