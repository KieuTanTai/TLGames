...
namespace TLGames.Infrastructure.Data
{
    ...
    public class FollowerOfDeveloperDAO(IDbConnectionFactory connectionFactory, IColumnService colService, IStringConverter converter, IStringChecker checker)
        ...
        IGetAllByIdAsync<FollowerOfDeveloperModel>, IGetSingleByIdsAsync<FollowerOfDeveloperModel>, IGetDataByDateTimeAsync<FollowerOfDeveloperModel>, IDeleteByIdsAsync
    {
        ...
        public async Task<List<FollowerOfDeveloperModel>> GetAllByTimeRangeAsync<TEnum>(string firstInputTime, string secondInputTime, string colName, TEnum timeType) where TEnum : Enum
        {
        ...
        public async Task<List<FollowerOfDeveloperModel>> GetAllByTimeAsync<TEnum>(string time, string colName, TEnum timeType) where TEnum : Enum
        {
            if (timeType is EDataTimeType)
            {
                string query = string.Empty;
