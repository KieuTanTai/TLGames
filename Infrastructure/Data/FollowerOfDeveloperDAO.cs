...
{
    internal class FollowerOfDeveloperDAO(IDbConnectionFactory connectionFactory) : BaseDAO<FollowerOfDeveloperModel>(connectionFactory), IGetAllByIdAsync<FollowerOfDeveloperModel>, 
